...
public class FragmentPrincipal extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        int images[] = {R.drawable.fondovviewlist,R.drawable.protecciondos,R.drawable.protecciontres,R.drawable.proteccioncuatro };
        mviewFlipper = getView().findViewById(R.id.viewflipper);
